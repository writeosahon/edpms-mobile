                                    ...
                                    $('#project-evaluation-page .project-evaluation-slider').each(function (index, element) {
                                        var aSlider = new ej.inputs.Slider({
                                            ...
                                            changed: function changed(changedEvent) {
                                                ...
                                                $('#project-evaluation-page .project-evaluation-slider:nth-of-type(' + (index + 1) + ') ~ .project-evaluation-milestone-current-value').html('<span style="display: inline-block; font-style: italic">Value Completed </span> \n                                    ' + kendo.toString(kendo.parseFloat(changedEvent.value / 100 * dbQueryResult.docs[index].AMOUNT), "n2"));
                                                // update the project evaluation started flag to indicate evaluation has started
                                                utopiasoftware[utopiasoftware_app_namespace].controller.projectEvaluationPageViewModel.hasProjectEvaluationStarted = true;
                                            }
                                        });
                    ...
                    while (1) {
                        switch (_context11.prev = _context11.next) {
                            ...
                            case 3:
                                ...
                                _context11.next = 6;
                                return ons.notification.confirm('', { title: '<ons-icon icon="md-delete" style="color: #3f51b5" size="33px"></ons-icon> <span style="color: #3f51b5; display: inline-block; margin-left: 1em;">Delete Photo</span>',
