...
utopiasoftware[utopiasoftware_app_namespace].controller = {
                    ...
                    while (1) {
                        switch (_context3.prev = _context3.next) {
                            ...
                            case 4:
                                ...
                                _context3.next = 8;
                                return ons.notification.alert('No evaluation reports to upload', { title: '<ons-icon icon="md-info" style="color: #3f51b5" size="33px"></ons-icon> <span style="color: #3f51b5; display: inline-block; margin-left: 1em;">No Reports</span>',
                            ...
                            case 10:
                                _context3.next = 12;
                                return ons.notification.alert('All evaluation reports successfully uploaded. <br>' + totalUploads + ' in total', { title: '<ons-icon icon="fa-check" style="color: #00B2A0" size="25px"></ons-icon> <span style="color: #00B2A0; display: inline-block; margin-left: 1em;">Uploaded Evaluation Reports</span>',
                                    buttonLabels: ['OK'], modifier: 'utopiasoftware-alert-dialog' });
                ...
                return regeneratorRuntime.wrap(function _callee7$(_context7) {
                    while (1) {
                        switch (_context7.prev = _context7.next) {
                            ...
                            case 28:
                                databaseResponse = _context7.sent;
                            ...
                            case 38:
                                ...
                                $('#loader-modal').get(0).hide();
                                ons.notification.alert(_context7.t1.message, { title: '<span style="color: red">Sign In Failed</span>',
                                    buttonLabels: ['OK'], modifier: 'utopiasoftware-alert-dialog' });
    ...
    searchProjectPageViewModel: {
        ...
        searchButtonClicked: function () {
            var _ref9 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee9(keyEvent) {
                ...
                return regeneratorRuntime.wrap(function _callee13$(_context13) {
                    while (1) {
                        switch (_context13.prev = _context13.next) {
                            ...
                            case 9:
                                leaveProjectEvaluation = _context13.sent;
                    ...
                    while (1) {
                        switch (_context14.prev = _context14.next) {
                            ...
                            case 10:
                                ...
                                _context14.t0 = pictureNumber;
                                _context14.next = _context14.t0 === 1 ? 14 : _context14.t0 === 2 ? 17 : _context14.t0 === 3 ? 20 : 23;
                                break;
                            ...
                            case 27:
                                ...
                                window.plugins.toast.showWithOptions({
                                    message: "Photo Capture Failed - " + _context14.t1,
                                    duration: 4000,
                                    position: "top",
                                    styling: {
                                        opacity: 1,
                    ...
                    while (1) {
                        switch (_context16.prev = _context16.next) {
                            ...
                            case 41:
                                ...
                                // inform the user of the error
                                window.plugins.toast.showWithOptions({
                                    message: "Location Capture Failed - " + (_context16.t0.message || _context16.t0),
                                    duration: 4000,
                                    position: "top",
                                    styling: {
                                        opacity: 1,
                    ...
                    while (1) {
                        switch (_context19.prev = _context19.next) {
                            case 0:
                                ...
                                projectEvaluationReportData.projectGeoPosition = utopiasoftware[utopiasoftware_app_namespace].controller.projectEvaluationPageViewModel.projectGeoPosition;
                            ...
                            case 22:
                                ...
                                return _context19.delegateYield(_loop(_index), 't0', 24);
