                    ...
                    switch (_context.prev = _context.next) {
                        case 0:
                            ...
                            try {
                                ...
                                utopiasoftware[utopiasoftware_app_namespace].model.appDatabase.crypto(window.localStorage.setItem("utopiasoftware-edpms-rid"), { ignore: '_attachments', cb: function cb(err, key) {
                                        console.log("ERR", err);
                                        console.log("KEY", key);
                                    } });
                            } catch (err) {
